...
namespace IMDB.Infrastructure.Observability.Formatters;
...
public class JsonLogFormatter : ITextFormatter
{
    ...
    protected void AddContextProperties(JsonObject result, LogEvent logEvent)
    {
        ...
        AddContextProperty(result, "tr", logEvent, "TrackingId");
        AddContextProperty(result, "ctx", logEvent, "SourceContext");
    }
