...
using IMDB.Infrastructure.Observability.Models.DTOs;
using OpenSearch.Client;
using OpenSearch.Net;
using Serilog;
using System.Text.Json;

namespace IMDB.Infrastructure.Observability.Sinks.OpenSearch;
...
internal class OpenSearchContext
{
    ...
    internal async Task Write(IEnumerable<string> messages)
    {
        try
        {
            ...
            // Do NOT use the default method for IndexMany because we are using a data stream
